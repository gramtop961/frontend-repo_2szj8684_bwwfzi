      ...
      <div className="relative z-10 mx-auto flex h-full max-w-6xl flex-col px-6">
        ...
        <div className="flex items-center justify-between py-6">
          ...
          <motion.nav
            ...
            className="hidden gap-1 rounded-full border border-black/5 bg-white/60 p-1 backdrop-blur md:flex dark:bg-black/40 dark:border-white/10"
          >
            {navItems.map((item) => (
              <a
                key={item.href}
                href={item.href}
                className="rounded-full px-4 py-2 text-sm text-gray-700 transition hover:bg-black/5 dark:text-gray-200 dark:hover:bg-white/10"
              >
                {item.label}
              </a>
            ))}
        ...
        <div className="flex grow flex-col items-start justify-center">
          ...
          >
            ...
            <div className="ml-2 flex items-center gap-2 rounded-full bg-white/70 px-2 py-2 backdrop-blur dark:bg-black/40">
              ...
              <a href="https://linkedin.com" target="_blank" rel="noreferrer" aria-label="LinkedIn" className="rounded-full p-2 hover:bg-black/5 dark:hover:bg_WHITE/10">
        ...
        >
          <a href="#about" className="rounded-full border border-black/10 bg-white/70 px-4 py-2 text-xs text-gray-700 backdrop-blur transition hover:bg-white dark:border-white/10 dark:bg-black/40 dark:text-gray-200 dark:hover:bg-black/60">
            Scroll to explore
          </a>
        </motion.div>
      </div>
